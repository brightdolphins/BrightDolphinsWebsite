# How to import WordPress to local Mamp
...
## Import Database to your local Mamp using phpMyAdmin
...
8. Go to the databases you created by clicking its name on the left menu.
...
_**Warning!!!** Some images might have some error loading after being imported please compared them to the [Live Site](https://brightdolphins.com/) and make changes to the ones that aren't loading correctly_

## Making new project pages

**Posts page is where we make changes to our portfolio/project**

To create a new portfolio/project, I recommended duplicating and modifying the existing page by...
...
5. Change project tags in the Tags section on the Left menu

6. Change the Featured image 

7. Change the Project description in the Excerpt section on the Left menu

8. To adjust and write more project detail Click on Edit with Elementor

## Adjusting other main pages
Pages page is where we make changes to all other main pages.
