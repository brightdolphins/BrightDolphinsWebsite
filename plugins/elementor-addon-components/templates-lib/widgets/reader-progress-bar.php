...
class Reader_Progress_Bar_Widget extends Widget_Base {
	...
	public function __construct( $data = array(), $args = null ) {
		...
		wp_register_script( 'eac-reader-progress', EAC_Plugin::instance()->get_script_url( 'templates-lib/assets/js/reader-progress' ), array( 'jquery', 'elementor-frontend' ), '2.1.1', true );
	}
