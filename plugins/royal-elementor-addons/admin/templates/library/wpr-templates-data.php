		...
		return [
			...
			'wooshop' => [
				'v1' => [
					...
					'plugins' => '{"woocommerce":'. $is_woo_active .'}',
					'tags' => 'free shop shopping woo-commerce woocommerce estore ecommerce shop ecommerce product online shop online store boutique clothes eshopping fashion designer market reseller digital purchases',
					'theme-builder' => false,
					'woo-builder' => true,
					'off-canvas' => false,
					'price' => $is_pro_active ? 'free' : 'free',
			...
			'travel-blog' => [
				'v1' => [
					...
					'pages' => 'home,home-v1,home-v2,category,about,contact,',
					'plugins' => '{}',
					'tags' => 'free nature influencer travel blogger blog posts content tourism influencers creator travel forest slider generic multipurpose national-park nature-park sanctuary wilderness slider hitchhiking mountain river lakes outdoors theme builder traveler hiking grid',
					'theme-builder' => true,
					'woo-builder' => false,
					'off-canvas' => false,
					'price' => $is_pro_active ? 'free' : 'free',
