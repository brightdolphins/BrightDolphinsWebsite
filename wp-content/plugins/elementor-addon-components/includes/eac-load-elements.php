...
class Eac_Load_Elements {
	...
	public function __construct() {
		...
		if(Eac_Config_Elements::is_widget_active('woo-product-grid')) {
			require_once(__DIR__ . '/woocommerce/eac-woo-hooks.php');
		} else {
	...
	public function register_categories($elements_manager) {
		...
		$elements_manager->add_category('eac-elements', array('title' => esc_html__('EAC Composants', 'eac-components'), 'icon' => 'fa fa-plug'));
	}
