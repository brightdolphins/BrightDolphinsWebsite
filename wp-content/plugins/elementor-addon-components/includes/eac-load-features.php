...
class Eac_Load_Features {
	...
	public function add_json_mime_type($mimes) {
		...
		if(is_admin() && (Eac_Config_Elements::is_widget_active('lottie-background') || Eac_Config_Elements::is_widget_active('lottie-animations') || Eac_Config_Elements::is_widget_active('open-streetmap'))) {
	...
	public function load_features() {
		 ...
		 */
		require_once(__DIR__ . '/eac-shortcode.php');
		 ...
		 */
		require_once(__DIR__ . '/eac-global-widgets.php');
		 ...
		 * @since 1.9.3
		 */
		require_once(__DIR__ . '/eac-plugin-updater.php');
		 ...
		 * @since 1.7.2
		 */
		require_once(__DIR__ . '/eac-tools.php');
		 ...
		 * @since 1.7.2
		 */
		require_once(__DIR__ . '/eac-helpers.php');
		
		/**
		 * Charge les fonctionnalités, notamment les dynamic tags Elementor
		 *
		 * @since 1.9.8
		 */
