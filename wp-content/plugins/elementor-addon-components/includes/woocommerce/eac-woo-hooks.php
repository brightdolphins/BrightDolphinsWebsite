...
class Eac_Woo_Filters {
	...
	public function add_woo_filters() {
		/** Redirection de l'URL de la page boutique vers la page Product Grid */
		//add_action('template_redirect', array($this, 'shop_url_redirect_to_product_grid'));
	...
	/**
	 * shop_url_redirect_to_product_grid
	 *
	 * Redirige l'URL de la boutique vers la page 'product grid'
	 */
	function shop_url_redirect_to_product_grid() {
		if(is_shop()) {
	 ...
	 */
	function turn_catalog_mode_on_for_product($html) {
		$options = get_option($this->wc_options_shop_name, false);
	...
	function add_product_meta_cats__() {
		...
		?>
		<div class="product_meta">
			<?php echo wc_get_product_category_list($product->get_id(), ' | ', '<span class="posted_in">' . _n('Category:', 'Categories:', count($product->get_category_ids()), 'eac-components') . ' ', '</span>'); ?> 
		</div>
		<?php
	}
	...
	function add_product_meta_tags__() {
		...
		?>
		<div class="product_meta">
			<?php echo wc_get_product_tag_list($product->get_id(), ' | ', '<span class="tagged_as">' . _n('Tag:', 'Tags:', count($product->get_tag_ids()), 'eac-components') . ' ', '</span>'); ?> 
		</div>
		<?php
	}
