...
use EACCustomWidgets\TemplatesLib\Widgets\Classes\Breadcrumb_Trail;
...
class Breadcrumb_Widget extends Widget_Base {
	...
	protected function render_breadcrumb() {
		...
		$args = array(
			...
			'item_tag'      => $settings['bdc_title_tag'],
			...
			'labels'        => array(
				'home'       => ! empty( $settings['bdc_home_title'] ) ? sanitize_text_field( $settings['bdc_home_title'] ) : 'Home',
				'page_title' => '',
			),
		);
