...
class Acf_Relationship_Widget extends Widget_Base {
	...
	public function __construct($data = [], $args = null) {
		...
		wp_register_style('eac-acf-relation', EAC_Plugin::instance()->get_register_style_url('acf-relationship'), array('eac'), EAC_ADDONS_VERSION);
	}
    ...
    */
    public function get_title() {
		return Eac_Config_Elements::get_widget_title('acf-relationship');
        //return esc_html__("ACF Relationship", 'eac-components');
    }
    ...
    */
    public function get_icon() {
        return 'eicon-posts-grid eac-icon-elements';
    }
