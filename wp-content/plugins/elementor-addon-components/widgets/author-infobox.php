...
class Author_Infobox_Widget extends Widget_Base {
    ...
    */
    public function get_name() {
        return 'eac-addon-author-infobox';
    }
    ...
    */
    public function get_title() {
		return Eac_Config_Elements::get_widget_title('author-infobox');
        //return esc_html__("Boîte auteur", 'eac-components');
    }
    ...
    */
    public function get_icon() {
        return 'eicon-person eac-icon-elements';
    }
	...
	*/
	...
	public function get_custom_help_url() {
        return 'https://elementor-addon-components.com/how-to-add-an-author-info-box-with-elementor/';
    }
