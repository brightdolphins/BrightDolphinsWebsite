...
class Image_Galerie_Widget extends Widget_Base {
    ...
    */
    public function get_title() {
		return Eac_Config_Elements::get_widget_title('image-galerie');
    ...
    */
    public function get_icon() {
        return 'eicon-gallery-masonry eac-icon-elements';
    }
	...
	*/
	...
	public function get_keywords() {
		return ['image', 'gallery', 'masonry', 'justify', 'grid', 'slider'];
	}
	...
	public function get_custom_help_url() {
        return 'https://elementor-addon-components.com/create-amazing-image-gallery-using-elementor/';
    }
