...
class Image_Promotion_Widget extends Widget_Base {
	...
	public function __construct($data = [], $args = null) {
		...
		wp_register_style('eac-image-promotion', EAC_Plugin::instance()->get_register_style_url('image-promotion'), array('eac'), EAC_ADDONS_VERSION);
		wp_register_style('eac-image-ribbon', EAC_Plugin::instance()->get_register_style_url('image-ribbon'), array('eac', 'eac-image-promotion'), EAC_ADDONS_VERSION);
    ...
    */
    public function get_title() {
		return Eac_Config_Elements::get_widget_title('image-promotion');
        //return esc_html__("Promotion de produit", 'eac-components');
    }
    ...
    */
    public function get_icon() {
        return 'eicon-price-table eac-icon-elements';
    }
		...
		$this->start_controls_section('ip_global_settings',
			...
			$this->add_control('ip_ribbon_position',
				[
					...
					'default' => 'left',
					'options' => [
						'left' => esc_html__('Gauche', 'eac-components'),
						'right' => esc_html__('Doite', 'eac-components'),
					],
    ...
    */
	...
	?>	
		...
		<?php if($iptitle) : ?>
			<?php echo $open_title; ?>
				<?php echo sanitize_text_field($settings['ip_title']); ?>
