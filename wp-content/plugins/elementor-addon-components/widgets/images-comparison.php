...
class Images_Comparison_Widget extends Widget_Base {
    ...
    */
    public function get_title() {
		return Eac_Config_Elements::get_widget_title('images-comparison');
        //return esc_html__("Comparaison d'images", 'eac-components');
    }
    ...
    */
    public function get_icon() {
        return 'eicon-image-before-after eac-icon-elements';
    }
