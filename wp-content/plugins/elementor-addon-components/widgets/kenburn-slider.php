...
class KenBurn_Slider_Widget extends Widget_Base {
    ...
    */
    public function get_title() {
		return Eac_Config_Elements::get_widget_title('kenburn-slider');
        //return esc_html__("Carrousel Ken Burn", 'eac-components');
    }
    ...
    */
    public function get_icon() {
        return 'eicon-media-carousel eac-icon-elements';
    }
