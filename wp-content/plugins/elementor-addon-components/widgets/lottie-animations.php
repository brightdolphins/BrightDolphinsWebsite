...
class Lottie_Animations_Widget extends Widget_Base {
	...
	public function get_name() {
		return 'eac-addon-lottie-animations';
	}
	...
	public function get_title() {
		return Eac_Config_Elements::get_widget_title('lottie-animations');
		//return esc_html__('Lottie animation', 'eac-components');
	}
	...
	public function get_icon() {
		return 'eicon-lottie eac-icon-elements';
	}
	...
	*/
	...
	public function get_custom_help_url() {
        return 'https://elementor-addon-components.com/add-lottie-animation-in-elementor/';
    }
