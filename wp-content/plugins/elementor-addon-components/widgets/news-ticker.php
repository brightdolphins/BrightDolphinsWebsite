...
class News_Ticker_Widget extends Widget_Base {
    ...
    */
    public function get_title() {
		return Eac_Config_Elements::get_widget_title('news-ticker');
        //return esc_html__("Fil d'actualité", 'eac-components');
    }
    ...
    */
    public function get_icon() {
        return 'eicon-posts-ticker eac-icon-elements';
    }
	...
	*/
	...
	public function get_custom_help_url() {
        return 'https://elementor-addon-components.com/add-a-news-ticker-reader-in-elementor/';
    }
