...
class Simple_PDF_Viewer_Widget extends Widget_Base {
	...
	public function get_title() {
		return Eac_Config_Elements::get_widget_title('pdf-viewer');
		//return esc_html__('Visionneuse PDF', 'eac-components');
	}
	...
	public function get_icon() {
		return 'far fa-file-pdf eac-icon-elements';
	}
	...
	*/
	...
	public function get_custom_help_url() {
        return 'https://elementor-addon-components.com/add-a-pdf-viewer-to-elementor';
    }
