...
class Pinterest_Rss_Widget extends Widget_Base {
    ...
    */
    public function get_title() {
		return Eac_Config_Elements::get_widget_title('pinterest-rss');
        //return esc_html__("Flux Pinterest", 'eac-components');
    }
    ...
    */
    public function get_icon() {
        return 'eicon-social-icons eac-icon-elements';
    }
