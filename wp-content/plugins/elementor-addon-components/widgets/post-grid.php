...
class Articles_Liste_Widget extends Widget_Base {
    ...
    */
    public function get_title() {
		return Eac_Config_Elements::get_widget_title('articles-liste');
        //return esc_html__("Grille d'articles", 'eac-components');
    }
    ...
    */
    public function get_icon() {
        return 'eicon-posts-masonry eac-icon-elements';
    }
	...
	*/
	...
	public function get_keywords() {
		return ['post', 'custom post_type', 'query', 'filter', 'category', 'authors', 'post_tag', 'custom fields', 'acf', 'slider'];
	}
