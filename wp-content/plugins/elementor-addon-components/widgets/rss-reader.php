...
class Lecteur_Rss_Widget extends Widget_Base {
    ...
    */
    public function get_title() {
		return Eac_Config_Elements::get_widget_title('lecteur-rss');
        //return esc_html__("Flux RSS", 'eac-components');
    }
	...
	*/
	...
	public function get_custom_help_url() {
        return 'https://elementor-addon-components.com/how-to-add-rss-feed-reader-with-elementor/';
    }
