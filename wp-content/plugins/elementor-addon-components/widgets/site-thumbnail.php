...
class Site_Thumbnails_Widget extends Widget_Base {
    ...
    */
    public function get_title() {
		return Eac_Config_Elements::get_widget_title('site-thumbnail');
        //return esc_html__("Miniature de site", 'eac-components');
    }
    ...
    */
    public function get_icon() {
        return 'eicon-thumbnails-right eac-icon-elements';
    }
