...
class Table_Of_Contents_Widget extends Widget_Base {
	...
	public function __construct($data = [], $args = null) {
		...
		wp_register_style('eac-table-content', EAC_Plugin::instance()->get_register_style_url('toctoc'), array('eac'), EAC_ADDONS_VERSION);
	}
    ...
    */
    public function get_title() {
		return Eac_Config_Elements::get_widget_title('table-content');
        //return esc_html__("Table des matières", 'eac-components');
    }
    ...
    */
    public function get_icon() {
        return 'eicon-table-of-contents eac-icon-elements';
    }
