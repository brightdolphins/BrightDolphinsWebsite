...
class Team_Members_Widget extends Widget_Base {
    ...
    */
    public function get_title() {
		return Eac_Config_Elements::get_widget_title('team-members');
        //return esc_html__("Membres de l'équipe", 'eac-components');
    }
	...
	*/
	...
	public function get_custom_help_url() {
        return 'https://elementor-addon-components.com/how-to-create-a-team-members-page-with-elementor/';
    }
