...
class WC_Product_Grid_Widget extends Widget_Base {
	...
	/**
	 * Constructeur de la class Product_Grid_Widget
	 * 
	...
	public function __construct($data = [], $args = null) {
		...
		wp_register_style('eac-post-grid', EAC_Plugin::instance()->get_register_style_url('post-grid'), array('eac'), EAC_ADDONS_VERSION);
    ...
    */
    public function get_name() {
        return Eac_Config_Elements::get_widget_name('woo-product-grid');
    }
    ...
    */
    public function get_title() {
		return Eac_Config_Elements::get_widget_title('woo-product-grid');
    }
    ...
    */
    public function get_icon() {
        return Eac_Config_Elements::get_widget_icon('woo-product-grid');
    }
	...
	*/
	...
	public function get_keywords() {
		return Eac_Config_Elements::get_widget_keywords('woo-product-grid');
	}
	...
	public function get_custom_help_url() {
        return Eac_Config_Elements::get_widget_help_url('woo-product-grid');
    }
    ...
    */
	protected function register_controls() {
				...
				$this->start_controls_tab('al_content_product',
					...
					$this->add_control('al_prices',
						[
							...
							'return_value' => 'yes',
							'default' => 'yes',
							'condition' => ['al_product_catalog!' => 'yes'],
						]
					);
		...
		$this->start_controls_section('al_product_page',
			...
			/*$this->add_control('al_product_catalog_warning',
				[
					'type' => Controls_Manager::RAW_HTML,
					'content_classes' => 'elementor-panel-alert elementor-panel-alert-warning',
					'raw'  => esc_html__("Vous devez recharger la page pour que la modification soit prise en compte dans le front-end", "eac-components"),
				]
			);*/
			...
			<div <?php echo $this->get_render_attribute_string('posts_wrapper'); ?>>
				...
				while($the_query->have_posts()) {
					...
					if(get_option('woocommerce_cart_redirect_after_add') === 'yes') {
						...
						$product_cart_url = esc_url(get_permalink($product_id)) . '?add-to-cart=' . $product_id;
					}
				...
				?>	
					<article id="<?php echo 'post-' . $product_id; ?>" class="<?php echo $article_class; ?>">
