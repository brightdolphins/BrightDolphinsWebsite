...
class Lecteur_Audio_Widget extends Widget_Base {
    ...
    */
    public function get_title() {
		return Eac_Config_Elements::get_widget_title('lecteur-audio');
        //return esc_html__("Flux webradio", 'eac-components');
    }
    ...
    */
    public function get_icon() {
        return 'eicon-headphones eac-icon-elements';
    }
