...
(function($) {
    ...
    $('#all-advanced').on('click', function() {
		if($(this).prop('checked') == true) {
			$('.eac-elements-table.advanced input').prop('checked', 1);
		} else if($(this).prop('checked') == false){
			$('.eac-elements-table.advanced input').prop('checked', 0);
		}
    ...
    $('#all-components').on('click', function() {
		if($(this).prop('checked') == true) {
			$('.eac-elements-table.common input').prop('checked', 1);
		} else if($(this).prop('checked') == false){
			$('.eac-elements-table.common input').prop('checked', 0);
		}
		$('#eac-elements-saved').css('display', 'none');
		$('#eac-elements-notsaved').css('display', 'none');
    });
    ...
    $('#all-features-advanced').on('click', function() {
		if($(this).prop('checked') == true) {
			$('.eac-features-table.advanced input').prop('checked', 1);
		} else if($(this).prop('checked') == false){
			$('.eac-features-table.advanced input').prop('checked', 0);
		}
		$('#eac-features-saved').css('display', 'none');
		$('#eac-features-notsaved').css('display', 'none');
    });
    ...
    $('#all-features-common').on('click', function() {
		if($(this).prop('checked') == true) {
			$('.eac-features-table.common input').prop('checked', 1);
		} else if($(this).prop('checked') == false){
			$('.eac-features-table.common input').prop('checked', 0);
		}
		$('#eac-features-saved').css('display', 'none');
		$('#eac-features-notsaved').css('display', 'none');
    });
